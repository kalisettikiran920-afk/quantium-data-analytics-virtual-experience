...
[![Forage](https://img.shields.io/badge/Forage-Job%20Simulation-00A99D?style=for-the-badge)](.)
...
flowchart LR
    A["📥 Raw Transaction &
    Customer Data"] --> B["🧹 Data Cleaning &
    Feature Engineering"]
    B --> C["📊 Customer Segment &
    Brand Analysis"]
    C --> D["🧪 Control Store
    Selection"]
    D --> E["📈 Trial vs Control
    Uplift Testing"]
    E --> F["📑 Pyramid Principle
    Client Report"]
    F --> G["✅ Strategic
    Recommendation"]
```
...
| [**→ View Task 1**](./Task-1-Customer-Behaviour-Analytics) | [**→ View Task 2**](./Task-2-Experimentation-and-Uplift-Testing) | [**→ View Task 3**](./Task-3-Commercial-Insights-and-Strategic-Recommendationss) |
